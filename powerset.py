...
# your job: complete the 3 functions randomSet, powerset, printSet
# there should be no need for helper functions in this problem
# you just need to fill in where it says 'ADD YOUR CODE HERE'
